...
# model
parser.add_argument("-model_name", type=str, choices=['CNN', 'MultiCNN', 'MSLAN_ACG', 'bert_seq_cls'], default='MSLAN_ACG')
...
parser.add_argument("-graph_embed_file", type=str, default='./data/mimic3/processed_full_ent.embed')
